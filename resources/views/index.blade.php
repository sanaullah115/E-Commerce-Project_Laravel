        ...
        <div class="tab-class text-center">
            <div class="row g-4">
                <div class="col-lg-4 text-start">
                    <h1>Our Daily Products</h1>
                </div>
                <div class="col-lg-8 text-end">
                    <ul class="nav nav-pills d-inline-flex text-center mb-5">
                        <!-- All Products Tab -->
                        <li class="nav-item">
                            <a class="d-flex m-2 py-2 bg-light rounded-pill all-products active" data-bs-toggle="pill"
                                href="javascript:void(0);" id="all-products">
                                <span class="text-dark" style="width: 130px;">All Products</span>
                            </a>
                        </li>
                        @foreach ($Sub_Category as $sub_cat)
                        <li class="nav-item sub-cat-li" data-sub-cat-id="{{ $sub_cat->id }}">
            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    ...
                    <div class="row g-4 front-product-div" aria-busy="false">
...
<div class="container-fluid vesitable py-5">
    <div class="container py-5">
        <h1 class="mb-0">Fresh DailyFruits</h1>
                ...
                <div class="p-4 rounded-bottom">
                    ...
                    <div class="d-flex justify-content-between flex-lg-wrap">
                        ...
                        <a href="{{Auth::user() ?'javascript:void(0);': route('login')}}"
                            ...
                            data-product_id="{{$item->id}}"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to
                            cart</a>
                    </div>
                </div>
            </div>
                ...
                <div class="p-4 rounded bg-light">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            ...
                            <a href="{{Auth::user() ?'javascript:void(0);': route('login')}}"
                                class="btn border border-secondary rounded-pill px-3 text-primary add_to_cart"
                                data-product_id="{{$item->id}}"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add
                                to cart</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="p-4 rounded bg-light">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <a href="{{Auth::user() ?'javascript:void(0);': route('login')}}" class="h5">Organic
                                Tomato</a>
                            <div class="d-flex my-3">
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
