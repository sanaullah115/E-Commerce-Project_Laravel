                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                            method="POST" action="{{ route('update', $user->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="title" name="name" required="required" value="{{$user->name}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="last-name" name="email" required="required" value="{{$user->email}}"
                                        class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="last-name" name="password" required="required" value="{{$user->password}}"
                                        class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
