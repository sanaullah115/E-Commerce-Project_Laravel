                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center mt-2">
                                            <img src="{{asset('/Upload/Product/'.$cart->product->image)}}" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                        </div>
                                    </th>
                                    <td class="py-5">{{ $cart->product->title }}</td>
                                    <td class="py-5">${{ $cart->product->discount }}</td>
                                    <td class="py-5">{{ $cart->Quantity }}</td>
                                    <td class="py-5">${{$cart->product->price * $cart->Quantity}}</td>
                                </tr>
                                @endforeach
                                ...
                                <tr>
                                    ...
                                    <td class="py-5">
                                        <div class="py-3 border-bottom border-top">
                                            <p class="mb-0 text-dark">{{$totalpayout}}</p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
